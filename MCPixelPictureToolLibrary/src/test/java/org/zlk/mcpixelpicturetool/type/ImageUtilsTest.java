...
//        ImageUtils.toFile(new File("1_512.jpeg"),nImage2,"jpg");
        BufferedImage image1 = ImageUtils.fromFile(new File("src/test/resources/icon.png"));
        ImageUtils.toFile(new File("src/test/resources/icon_512.png"), ImageUtils.resize(image1, 512, 512), "png");
    }

    @Test
    void test1() throws IOException {
        BufferedImage image = ImageUtils.fromFile(new File("src/test/resources/icon.png"));
